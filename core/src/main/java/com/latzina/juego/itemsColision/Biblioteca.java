...
public class Biblioteca extends ObjetoInteractivo{

	public Biblioteca(World mundo, TiledMap mapa, Rectangle objeto) {
	...
	public void golpearCabeza() {
		...
		Render.juego.realizarAccion("Biblioteca",super.textosInteraccion[MathUtils.random(textosInteraccion.length-1)]);
